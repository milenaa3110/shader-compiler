...
inline llvm::AllocaInst* CreateEntryBlockAlloca(llvm::Function* F, const std::string& name, llvm::Type* ty) {
...
// arg0TypeName identifies the sampler/image type (e.g. sampler2D/sampler3D).
// arg0Binding identifies the specific texture/resource binding.
llvm::Value* codegenBuiltin(llvm::IRBuilder<>& B, llvm::Module* M, const std::string& name,
                            const std::vector<llvm::Value*>& args,
                            const std::string& arg0TypeName = "", int arg0Binding = 0);
